...
function drawResultTable(entityType, data, page) {
    ...
    console.log("drawResultTable("+entityType+", "+data+", "+page+")")
...
function search(entityType, keyword, page) {
    console.log("####--- SEARCH.JS ---####");
    currentPage = page;
    console.log('search('+entityType+', '+keyword+', '+ page+')');
    console.log('befor SwaggerClient Call');
        ...
        success: function () {
            ...
            switch (entityType) {
                case "gene":
                    ...
                    break;
                case "protein":
                    swagger.apis.protein.getProteinsByKeyWord({_format: ".sparql-json", keyword: keyword, _pageSize: pageSize, _page: page},
                        {responseContentType: 'text/html'}, function (data) {
                            drawResultTable(entityType, data, page);
                    });
                    break;
                case "qtl":
                    swagger.apis.qtl.getQtlsByKeyWord({_format: ".sparql-json", keyword: keyword, _pageSize: pageSize, _page: page},
                        {responseContentType: 'text/html'}, function (data) {
                            drawResultTable(entityType, data, page);
                    });
                    break;
                case "pathway":
                    swagger.apis.pathway.getPathwaysByKeyWord({_format: ".sparql-json", keyword: keyword, _pageSize: pageSize, _page: page},
                        {responseContentType: 'text/html'}, function (data) {
                            drawResultTable(entityType, data, page);
                    });
                    break;
                case "ontology":
                    swagger.apis.ontologies.getOntologyTermsByKeyWord({_format: ".sparql-json", keyword: keyword, _pageSize: pageSize, _page: page},
                        {responseContentType: 'text/html'}, function (data) {
                            drawResultTable(entityType, data, page);
                    });
                    break;
