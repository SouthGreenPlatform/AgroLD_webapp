...
//    });
    ...
    searchParentById : function(page) {
        ...
        var tthis = this;
        swagger.apis.ontologies.getParentById({_format: ".sparql-json", id:ModalContext.id , _pageSize: pageSize, _page: page},
    ...
    searchChildrenById : function(page) {
        ...
        displayHoldMessage(type + "Result");  
        var tthis = this;
        swagger.apis.ontologies.getChildrenById({_format: ".sparql-json", id: ModalContext.id , _pageSize: pageSize, _page: page},
        {responseContentType: 'application/json'}, function (data) {
    ...
    searchQtlsIdAssociatedWithOntoId : function(page) {
        ...
        displayHoldMessage(type + "Result");
        var tthis = this;
        swagger.apis.qtl.getQtlsIdAssociatedWithOntoId({_format: ".sparql-json", ontoId: ModalContext.id , _pageSize: pageSize, _page: page},
        {responseContentType: 'application/json'}, function (data) {
            sparqljson = data.data;
            resultId = type + "Result";
            displayResult(resultId, sparqljson);
    ...
    searchProteinIdAssociatedWithOntoId: function(page) {
        ...
        displayHoldMessage(type + "Result");  
        var tthis = this;
        swagger.apis.protein.getProteinIdAssociatedWithOntoId({_format: ".sparql-json", ontoId: ModalContext.id , _pageSize: pageSize, _page: page},
        {responseContentType: 'application/json'}, function (data) {
            sparqljson = data.data;
            resultId = type + "Result";
            displayResult(resultId, sparqljson);
