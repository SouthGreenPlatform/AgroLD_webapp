...
public class ProteinDAO {
    ...
    public static String getAllProteinsURI(String resultFormat) {
        ...
        String sparqlQuery = "prefix	agrold_vocabulary:<http://www.southgreen.fr/agrold/vocabulary/> \n"
               ...
               // + "    ?protein a <http://www.southgreen.fr/agrold/vocabulary/Gene>.\n"
                + "    ?protein agrold_vocabulary:description ?desc; \n"
                + "          rdf:label ?label .\n"
                + "  }\n"
                + "FILTER(REGEX(?g, \"http://www.southgreen.fr/agrold/*\") && REGEX(?protein, \"http://purl.uniprot.org/uniprot/*\"))\n"
                + "}";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getAllProteinsURI(resultFormat));
    }
}
