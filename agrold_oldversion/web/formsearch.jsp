<%-- 
    Document   : formsearch
    Created on : Jun 12, 2015, 2:46:50 PM
    Author     : tagny
--%>
...
<html>
    <head>
        <title>Faceted quick search - by keywords</title>
        <meta charset="UTF-8">
        ...
        <script>
            ...
            var eltTypeService = ["/agrold/api/res/genes.json", "/agrold/api/res/proteins.json", "/agrold/api/res/qtls.json"];
            var sTypeElts;
            var input;
