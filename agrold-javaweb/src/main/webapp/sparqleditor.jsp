<%-- Document : sparqleditor Created on : Jul 15, 2015, 3:18:01 PM Author : tagny --%>
            ...
            <div class="foowrap">
                <div class="d-flex flex-column align-items-center justify-content-center ml-3 mr-3">
                    <span>
                        ...
                        <button href="javascript:void(0);"
                            onclick="javascript:introJs().setOption('showProgress', true).start();" class="yasrbtn"
                            style="background-color: #00B5AD!important; color: white; font-weight: bold">
                            Watch how!
                        </button>
                    </span>
                    <hr />
                ...
                <div class="container-fluid">
                    <div id="main" style="overflow:auto;">
                        <div id="sparql">
                            <div id="cmd-container" data-step="6"
                                data-intro="Hand over to see what shortcuts are available">
...
LIMIT 10
                            ...
                            <div>
                                <table width="100%">
                                    <tr>
                                        <td align="left" data-step="7"
                                            data-intro="You can save your query in a file and then ... "
                                        ...
                                        <td align="right" data-step="8"
                                            ...
                                            <button class="yasrbtn"
                                                onclick="loadFileAsText(document.getElementById('fileToLoad').files[0]);">
